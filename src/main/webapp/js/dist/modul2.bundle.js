...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__page4_vue__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__page5_vue__ = __webpack_require__(27);



const routes = [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_0__page4_vue__["a" /* default */] }, { path: '/page5', component: __WEBPACK_IMPORTED_MODULE_1__page5_vue__["a" /* default */] }];
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    'inputons': {
      template: "<div>" + "{{labelvalue}}<input type='text' class='form-control' @keyup.stop='update(labelvalue, $event.target.value)' />" + "</div>",
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "keyup": function($event) {
        ...
        _vm.update($event.target.value, 'form.params.username.value')
      }
    }
  })])]), _vm._v(" "), _c('div', _vm._l((this.$store.state.input1), function(r) {
    return _c('div', {
      key: r.id
    }, [_c('inputons', {
      attrs: {
  ...
  }, [_vm._v("モーダル")]), _vm._v(" "), (_vm.isModal) ? _c('transition', {
    attrs: {
      "name": "modal"
    }
  }, [_c('div', {
  ...
  }, [_vm._v("閉じる")])])])]) : _vm._e(), _vm._v(" "), _c('button', {
    on: {
      "click": _vm.toPage5
    }
